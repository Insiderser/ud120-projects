...
print("Score on training dataset:", reg.score(feature_train, target_train))
print("Score on training dataset:", reg.score(feature_test, target_test))
print()
